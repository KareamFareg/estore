                    ...
                    <div class="detail-info">
                        ...
                        <div class="product-rating">
                            ...
                            @for($i=1;$i<=5;$i++)
                                ...
                                @endif
                            @endfor
                            <p  class="count-review">({{$product->orderItems->where('rstatus',1)->count()}} review)</p>
                        </div>
                        ...
                        <div class="quantity">
                            <span class="text-danger">Max Quantity : <strong style="color: red">{{$product->quantity}}</strong></span>
                        </div>
                        <div class="wrap-butons">
                            @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                                <div class="wrap-price" style="padding-bottom: 20px">
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="add_infomation">
                                <table class="shop_attributes">
                                    <tbody>
                                    <td>There is no Addtional Infomation Yet </td>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <ol class="commentlist">
                                            ...
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container">
                                                    <img alt="" src="{{asset('assets/images/users')}}/{{$orderItem->order->user->profile_photo_path}}" height="80" width="80">
                        ...
                        <ul class="our-services">
                            ...
                            <li class="service">
                                <a class="link-to-service" >
                                    ...
                                    <div class="right-content">
                                        ...
                                        <p class="desc">You Order and We will reach wherever you are FOR FREE !!!</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service" >
                                    ...
                                    <div class="right-content">
                                        <b class="title">Special Offers</b>
                                        <p class="desc">There are a lot of Coupons for Discount</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="service">
                                <a class="link-to-service">
                                    ...
                                    <div class="right-content">
                                        <b class="title">Order Cancel</b>
                                        <span class="subtitle">Cancel order within 7 days</span>
                                        <p class="desc">You can Cancel any Order within 7 days from Ordered date </p>
                                    </div>
                                </a>
                            </li>
                        </ul>
